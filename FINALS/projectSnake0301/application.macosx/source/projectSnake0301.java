...
public class projectSnake0301 extends PApplet {
...
class Snake {
  ...
  public void death() {
    ...
    if (level > 0) {
      float p = dist(snakeLoc.x, snakeLoc.y, f.poison.x, f.poison.y);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "projectSnake0301" };
    if (passedArgs != null) {
